...
var instructions = {
  type: 'instructions',
  pages: function(){
    pageOne = '<div style="font-size:20px;"><b>Instructions</b><br><br><br>This is the operation span task. <br><br>\
    This task has two parts: <br>(1) Letter memorization <br>(2) Math problem solving<br><br><br></div>'
    
    pageTwo = '<div style="font-size:20px;">We will first practice <b>letter memorization</b>.<br><br>\
    A sequence of letters will appear on the screen one at a time (around 4 to 6 in a trial).<br>Try to remember each letter in the order presented.<br><br\
    >After letter presentation, you will see a screen listing 12 possible letters.<br>\
    Your task is to select each letter that was presented in its correct presentation order.<br><br></div>'
    
    pageThree = '<div style="font-size:20px;">Use the mouse to select the appropriate letters <br>\
    If you make a mistake use the provided "Backspace" button to clear your last response. <br><br>\
    Remember, it is important that you select the letters <b>in the order</b> that you saw them.<br>\
    So if you forget one of the letters, guess the best you can for that one, and select the rest in their correct order.<br>\
    <br>Press "Next" for practice trials.<br><br></div>'
...
var instructions2 = {
  type: 'instructions',
  pages: function(){
    pageOne = '<div style="font-size:20px;">You will next practice <b>math problem solving</b>.<br><br>\
    A simple math equation will appear on the screen, like this:<br>3 + 4 = 7<br>\
    Your task is to solve the math problem and determine if the answer provided to it is correct.<br><br></div>'
    
    pageTwo = '<div style="font-size:20px;">For example, if you see the following problem:<br>2 + 3 = 5<br>\
    you should click the <b>"True"</b> button because 2 and 3 added together equals 5.<br><br>\
    If you see the following problem:<br>2 + 3 = 6<br>you should click the <b>"False"</b> button because 2 and 3 added together <b>does not</b> equal 6.\
    <br><br><br>\
    Press "Next" to start practicing math problem solving.<br><br></div>'
...
var instructions3 = {
  type: 'instructions',
  pages: function(){
    pageOne = '<div style="font-size:20px;">We will now practice the two tasks together.<br><br>\
    In the next practice set, you will first be presented with a letter.<br>\
    Try and remember that letter.<br>After the letter dissapears, you will be provided with a math problem<br>\
    and you have to judge if the answer provided is true or false.<br><br>\
    It is important to work <b>quickly</b> and <b>accurately</b> on the math problem.<br>\
    Each math problem will be presented for only 6 seconds.<br><br></div>'
    
    pageTwo = '<div style="font-size:20px;">After the math problem, you will be shown another letter to remember,<br>\
    which will be followed by another math problem.<br><br>Therefore, letter presentations and math problems will alternate.<br>\
    After 3 to 6 letters have been presented, the recall screen will appear.<br>\
    Use the mouse to select the presented letters in their correct order.<br><br>\
    Do you have any questions?<br>Press "Next" to start practice rounds.<br><br></div>'
    return [pageOne, pageTwo]
  },
  allow_backward: true,
  button_label_next: "Next",
...
var instructions4 = {
  type: 'instructions',
  pages: function(){
    pageOne = '<div style="font-size:20px;">We have finished with the practice trials.<br><br></div>'
    return [pageOne]
  },
...
pages: function(){
  ...
  <b>We will now start with the main trials.</b><br>\
  Proceed only if you have understood the task.<br><br>\
  Press "Next" to start the main trials.<br><br></div>'
  return [pageOne]
},
allow_backward: false,
button_label_next: "Next",
...
timeline.push({
  ...
  message: '<p>Test moves to fullscreen after pressing the button.</p>'
});
